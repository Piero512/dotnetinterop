...
//
hostfxr_error_writer_fn HOSTFXR_CALLTYPE *hostfxr_set_error_writer_fn(hostfxr_error_writer_fn error_writer);
...
//
int32_t HOSTFXR_CALLTYPE hostfxr_initialize_for_dotnet_command_line_fn(
    int argc,
    const char_t **argv,
...
//
int32_t HOSTFXR_CALLTYPE hostfxr_initialize_for_runtime_config(
...
//
int32_t HOSTFXR_CALLTYPE hostfxr_get_runtime_property_value_fn(
...
//
int32_t HOSTFXR_CALLTYPE *hostfxr_set_runtime_property_value_fn(
    const hostfxr_handle host_context_handle,
    const char_t *name,
    const char_t *value);
...
//
int32_t HOSTFXR_CALLTYPE *hostfxr_get_runtime_properties_fn(
    const hostfxr_handle host_context_handle,
    /*inout*/ size_t * count,
...
//
int32_t HOSTFXR_CALLTYPE hostfxr_run_app_fn(const hostfxr_handle host_context_handle);
...
//     hdt_get_function_pointer
//
int32_t HOSTFXR_CALLTYPE hostfxr_get_runtime_delegate(
    const hostfxr_handle host_context_handle,
...
//     The error code result.
//
int32_t HOSTFXR_CALLTYPE hostfxr_close(const hostfxr_handle host_context_handle);
...
//
int32_t HOSTFXR_CALLTYPE hostfxr_get_dotnet_environment_info(
    const char_t* dotnet_root,
    void* reserved,
